/*
 * SentryPi
 * A Raspberry Pi app using a camera PIR motion sensor, with cloud storage & website
 *
 * Shady Attia 
 */
...
function sendSMS(url, timestamp) {
  ...
  let msg = 'Intruder detected on '+ t + '! See the photo at: ' + url;
